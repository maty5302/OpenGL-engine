...
ShaderProgram::ShaderProgram(Camera* camera, VertexShader* vertex, FragmentShader* fragment)
{
	this->camera = camera;
...
void ShaderProgram::update(const char* name, glm::vec4 value)
{
	this->setUniform(name, value);
}

void ShaderProgram::update(const char* name, glm::vec3 value)
{
	this->setUniform(name, value);
}

void ShaderProgram::update(const char* name, float value)
{
	this->setUniform(name, value);
}

void ShaderProgram::update(const char* name, glm::mat4 value)
{
	this->setUniform(name, value);
}

void ShaderProgram::update(const char* name, int value)
{
	this->setUniform(name, value);
}
...
void ShaderProgram::cancelShader()
{
	glUseProgram(0);
}

void ShaderProgram::setMatrixModel(glm::mat4 modelMatrix)
{
