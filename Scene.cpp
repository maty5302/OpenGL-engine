...
{
	Shader* shader = new Shader(this->camera, FileLoader::loadShader("Shaders/vertex.vert").c_str(), FileLoader::loadShader("Shaders/fragment.frag").c_str());
	Shader* shader2 = new Shader(this->camera, FileLoader::loadShader("Shaders/vertex.vert").c_str(), FileLoader::loadShader("Shaders/fragment.frag").c_str());
	Shader* shader3 = new Shader(this->camera, FileLoader::loadShader("Shaders/vertex.vert").c_str(), FileLoader::loadShader("Shaders/fragment.frag").c_str());
